...
class SingleInversionTest(unittest.TestCase):
    def test_mugello_model_runs_for_all_sites(self):
        model = ModelParameters(43.475, 10.55, 349.5, 79.5, 45.0, 9.0,
                                13.0, 13.0, 0.54, -0.54, 3.69, 2e24)
        observations = load_observations(ROOT / "data/liv1846-n108.txt")
        result = evaluate_model(model, observations)
